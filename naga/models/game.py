...
class HeroSkill(me.EmbeddedDocument):
    ...
    skill_type = me.StringField(required=True)
    damage = me.ListField(me.IntField())
    magic = me.ListField(me.IntField())
    life_steel = me.ListField(me.FloatField())
    move_speed = me.ListField(me.IntField())
    ...
    attack_speed =  me.ListField(me.FloatField())
